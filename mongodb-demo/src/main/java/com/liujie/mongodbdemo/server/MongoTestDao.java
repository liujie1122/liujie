...
public class MongoTestDao {
     ...
     * @return
     */
    public MongoTest findTestByName(@Nullable String name) {
     ...
     * @return
     */
    public MongoTest findTestById(Integer id) {
...
//         mongoTemplate.updateMulti(query,update,TestEntity.class);
     ...
     * @param mongoTest
     */
    public void deleteTest(MongoTest mongoTest) {
        mongoTemplate.remove(mongoTest);
    }
}
